    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 mx-auto">
                ...
                <div class="row form-group">
                    <label for="example-text-input" class="col-2 col-form-label text-right">{{ __('Student ID (Auto)')}}</label>
                    <div class="col-10">
                ...
                <div class="row form-group">
                    <label for="example-url-input" class="col-2 col-form-label text-right">{{ __('Birth Registration
...
{{--                </div>--}}
                ...
                <div class="row form-group">
                    <label for="example-datetime-local-input" class="col-2 col-form-label text-right">{{ __('NID No.')}}</label>
                    <div class="col-10">
...
{{--                </div>--}}
                ...
                <div class="row form-group">
                    <label for="example-time-input" class="col-2 col-form-label text-right">{{ __('Co Curricular Activities')}}</label>
                    <div class="col-10">
...
{{--                </div>--}}
                ...
                <div class="row form-group">
                    <label for="example-datetime-local-input" class="col-2 col-form-label text-right">{{ __('Mother Name')}}</label>
                    <div class="col-10">
                ...
                <div class="row form-group">
                    <label for="example-date-input" class="col-2 col-form-label text-right">{{ __('Father Occupation')}}</label>
                    <div class="col-10">
                ...
                <div class="row form-group">
                    <label for="example-month-input" class="col-2 col-form-label text-right">{{ __('Relation With Guardian')}}</label>
                    <div class="col-10">
                ...
                <div class="row form-group">
                    <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('Guardian Yearly Income')}}</label>
                    <div class="col-10">
                ...
                <div class="row form-group">
                    <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('Total Family Member')}}</label>
                    <div class="col-10">
                ...
                <div class="row form-group">
                    <label for="example-time-input" class="col-2 col-form-label text-right">{{ __('Guardian National ID')}}</label>
                    <div class="col-10">
                ...
                <h3 class="text-center">{{ __('Present Address')}}</h3>
