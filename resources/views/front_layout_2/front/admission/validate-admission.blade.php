...
@section('content')
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 text-white">
                    <h2 style="color: white">{{ __('Validate Admission')}}</h2>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb justify-content-md-end bg-transparent">
                        <li  class="breadcrumb-item">
                            <a style="color: white" href="#">{{ __('Home')}}</a>
                        </li>
                        <li  class="breadcrumb-item">
                            <a style="color: white" href="#"> {{ __('Admission')}}</a>
                        </li>
    ...
    <section class="padding-y-20 border-bottom mt-3">
