                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mx-auto">
                            ...
                            <div class="row form-group">
                                <label for="example-text-input" class="col-2 col-form-label text-right">{{ __('Session (Auto)')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-text-input" class="col-2 col-form-label text-right">{{ __('Class (Auto)')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-text-input" class="col-2 col-form-label text-right">{{ __('Group (Auto)')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-text-input" class="col-2 col-form-label text-right">{{ __('Student ID
                                    (Auto)')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-text-input" class="col-2 col-form-label text-right">{{ __('SSC Roll')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-text-input" class="col-2 col-form-label text-right">{{ __('Student Name')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-search-input" class="col-2 col-form-label text-right">{{ __('Gender')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-email-input" class="col-2 col-form-label text-right">{{ __('Date of Birth')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-url-input" class="col-2 col-form-label text-right">{{ __('Birth
                                    Registration Certificate Number')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-tel-input" class="col-2 col-form-label text-right">{{ __('Blood Group')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-password-input" class="col-2 col-form-label text-right">{{ __('Religion')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-datetime-local-input" class="col-2 col-form-label text-right">{{ __('NID
                                    No.')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-time-input" class="col-2 col-form-label text-right">{{ __('Marital Status')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('Mobile')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('Email')}}</label>
                                <div class="col-10">
                                    {{ Form::text('email',null,['class'=>'form-control','id'=>'input-email','readonly']) }}
                                </div>
                            </div>
                            <div class="row form-group">
                                <label for="example-time-input" class="col-2 col-form-label text-right">{{ __('Co Curricular
                                    Activities')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('Hobby')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('Quota')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('Transport
                                    (Optional)')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-number-input" class="col-2 col-form-label text-right">{{ __('Father Name')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-datetime-local-input" class="col-2 col-form-label text-right">{{ __('Mother
                                    Name')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-month-input" class="col-2 col-form-label text-right">{{ __('Guardian Name')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-date-input" class="col-2 col-form-label text-right">{{ __('Father
                                    Occupation')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-month-input" class="col-2 col-form-label text-right">{{ __('Relation With
                                    Guardian')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('Guardian Yearly
                                    Income')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('Total Family
                                    Member')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-time-input" class="col-2 col-form-label text-right">{{ __('Guardian
                                    National ID')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('Guardian Mobile')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('House Number')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('Village/Area')}}</label>
                                <div class="col-10">
                                    {{ Form::text('pre_village',null,['class'=>'form-control','id'=>'input-pre-village','readonly']) }}
                                </div>
                            </div>
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('Road/Block/Area')}}</label>
                                <div class="col-10">
                                    {{ Form::text('pre_road',null,['class'=>'form-control','id'=>'input-pre-road','readonly']) }}
                                </div>
                            </div>
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('Post Office')}}</label>
                                <div class="col-10">
                                    {{ Form::text('pre_post_office',null,['class'=>'form-control','id'=>'input-pre-post-office','readonly']) }}
                                </div>
                            </div>
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('Post Code')}}</label>
                                <div class="col-10">
                                    {{ Form::text('pre_post_code',null,['class'=>'form-control','id'=>'input-pre-post-code','readonly']) }}
                                </div>
                            </div>
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('Upzilla/Thana')}}</label>
                                <div class="col-10">
                                    {{ Form::text('pre_thana',null,['class'=>'form-control','id'=>'input-pre-thana','readonly']) }}
                                </div>
                            </div>
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('District')}}</label>
                                <div class="col-10">
            ...
            <div class="tab-pane fade" id="ssc-information" role="tabpanel">
                <div class="container">
                    <div class="row">
                        <div class="col-12 mx-auto">
                            <div class="row form-group">
                                <label for="example-number-input" class="col-2 col-form-label text-right">{{ __('Board')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-datetime-local-input" class="col-2 col-form-label text-right">{{ __('Passing
                                    Year')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-date-input" class="col-2 col-form-label text-right">{{ __('SSC Roll')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-month-input" class="col-2 col-form-label text-right">{{ __('SSC
                                    Registration')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-week-input" class="col-2 col-form-label text-right">{{ __('SSC Session')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-time-input" class="col-2 col-form-label text-right">{{ __('Student Type')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('GPA')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('SSC Group')}}</label>
                                <div class="col-10">
                            ...
                            <div class="row form-group">
                                <label for="example-textarea" class="col-2 col-form-label text-right">{{ __('SSC School')}}</label>
                                <div class="col-10">
            ...
            <div class="tab-pane fade" id="photograph" role="tabpanel">
                <div class="container">
                    <div class="row">
                        <div class="col-12 mx-auto">
                            <div class="row form-group">
                                <label for="example-number-input" class="col-2 col-form-label text-right">{{ __('Image')}}</label>
                                <div class="col-10">
