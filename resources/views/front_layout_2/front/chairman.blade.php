    ...
    <div class="container">
        ...
        <div class="row">
            ...
            @if($principal)
                <div class="py-2 col-6 col-sm-6 col-md-6 col-lg-6">
                    <div class="member d-flex">
                        <div class="thumb rounded overflow-hidden"><img alt="Chairman" class="img-fluid" src="{{ asset('storage/uploads/message') }}/{{ $principal->image ?? 'untitled.png' }}">
                        </div>
                        <div class="info">
                ...
                <div class="modal-body">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <img style="margin-top: 10px"  height="200px"  width="200px" src="{{ asset('storage/uploads/message') }}/{{ $chairman->image ?? 'untitled.png' }}" alt="">
                                </div>
                                <div class="col-md-8">
                                    <h2>
