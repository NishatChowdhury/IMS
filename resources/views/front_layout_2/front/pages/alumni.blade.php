                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <ul>
                                            ...
                                            <li>{{ __('ইসলামি ব্যাংক বাংলাদেশ লিমিটেডের বহদ্দারহাট শাখার হিসাব নম্বরঃ ১৯৩০১ তে টাকা জমা দিন।') }}</li>
                                            <li>{{ __('ব্যাঙ্কের বিস্তারিত তথ্যঃ') }}</li>
                                            <li>{{ __('রাঙ্গুনিয়া আলমশাহপাড়া কামিল (এম.এ.) মাসরাসা এর হিসাব নুম্বার ০০০০ বহদ্দারহাট শাখা' ) }}</li>
                                            <li>{{ __('অথবা, 01833 166166 নাম্বারে ১,০২০/- টাকা বিকাশ করুন।') }}</li>
                                            <li>{{ __('বিকাশের ক্ষেত্রে বিকাশ মোবাইল নাম্বার ও টিআরএক্স আইডি উক্ত ফর্মে প্রদান করুন।') }}</li>
                                            <li>{{ __('ব্যাংক ট্রান্সফার এর ক্ষেত্রে, ইসলামি ব্যাংক বাংলাদেশ লিমিটেডের বহদ্দারহাট শাখার হিসাব নম্বরঃ 19301 তে টাকা জমা দিন।') }}</li>
                                        </ul>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
