                ...
                <div class="col-lg-8 mt-4">
                    <div class="card shadow-v1">
                        <div class="position-relative">
                            <img class="card-img-top w-100" src="{{ asset('storage/uploads/events/') }}/{{ $event->image }}" alt="">
                            <div class="position-absolute bottom-0 width-100p bg-primary-0_7 text-center text-white">
                                <ul class="list-inline my-2" data-countdown="2019/01/01">
                                    <li class="list-inline-item iconbox iconbox-xxl bg-white-0_2 my-1">
                                        <h4 class="countdown-days font-size-md-28 mb-0 line-height-reset">{{ __('226')}}</h4>
                                        <small>{{ __('Days')}}</small>
                                    </li>
                                    <li class="list-inline-item iconbox iconbox-xxl bg-white-0_2 my-1">
                                        <h4 class="countdown-hours font-size-md-28 mb-0 line-height-reset">{{ __('12')}}</h4>
                                        <small>{{ __('Hours')}}</small>
                                    </li>
                                    <li class="list-inline-item iconbox iconbox-xxl bg-white-0_2 my-1">
                                        <h4 class="countdown-minutes font-size-md-28 mb-0 line-height-reset">{{ __('23')}}</h4>
                                        <small>{{ __('Minutes')}}</small>
                                    </li>
                                    <li class="list-inline-item iconbox iconbox-xxl bg-white-0_2 my-1">
                                        <h4 class="countdown-seconds font-size-md-28 mb-0 line-height-reset">{{ __('40')}}</h4>
