        ...
        <div class="collapse navbar-collapse when-collapsed" id="ec-nav__collapsible">
            <ul class="nav navbar-nav ec-nav__navbar ml-auto">
                    ...
                    <div class="dropdown-menu">
                        <ul class="list-unstyled">
                            ...
                            <li class="nav-item__has-dropdown">
                                <a class="nav-link__list dropdown-toggle" href="#" data-toggle="dropdown"> {{ __('About
                                    Institute')}} </a>
                                <div class="dropdown-menu">
                                    <ul class="list-unstyled">
                                        <li><a class="nav-link__list" href="{{ url('introduction') }}"> {{ __('Introduction')}} </a></li>
                                        <li><a class="nav-link__list" href="{{action('FrontController@governing_body')}}">{{ __('
                                            Governing Body')}}</a></li>
                                        <li><a class="nav-link__list" href="{{action('FrontController@donor')}}">
                                            {{ __('Founder & Donor')}}</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item__has-dropdown">
                                <a class="nav-link__list dropdown-toggle" href="#" data-toggle="dropdown">
                                    {{ __('Administrative Message')}} </a>
                                <div class="dropdown-menu">
                                    <ul class="list-unstyled">
                                        <li><a class="nav-link__list" href="{{ action('FrontController@president') }}">
                                            {{ __('President Message ')}}</a></li>
                                        <li><a class="nav-link__list" href="{{ action('FrontController@principal') }}">
                                            {{ __('Principal Message')}}</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item__has-dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <ul class="list-unstyled">
                                        <li><a class="nav-link__list" href="{{action('FrontController@building_room')}}">{{ __('
                                            Building & Rooms ')}}</a></li>
                                        <li><a class="nav-link__list" href="{{action('FrontController@library')}}">
                                            {{ __('Library')}}</a></li>
                                        <li><a class="nav-link__list" href="{{action('FrontController@transport')}}">
                                            {{ __('Transport')}}</a></li>
                                        <li><a class="nav-link__list" href="{{action('FrontController@hostel')}}">
                                            {{ __('Hostel')}}</a></li>
                                        <li><a class="nav-link__list" href="{{ action('FrontController@land_information') }}">{{ __('
                                            Land Information')}}</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item__has-dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <ul class="list-unstyled">
                                        <li><a class="nav-link__list" href="{{action('FrontController@class_routine')}}">
                                            {{ __('Class Routine')}} </a></li>
                                        <li><a class="nav-link__list" href="{{action('FrontController@calender')}}">{{ __('Academic
                                            Calender')}}</a></li>
                                        <li><a class="nav-link__list" href="{{action('FrontController@syllabus')}}">
                                            {{ __('Syllabus')}}</a></li>
                                        <li><a class="nav-link__list" href="{{ action('FrontController@diary') }}">
                                            {{ __('Diary')}}</a></li>
                                        <li><a class="nav-link__list" href="{{action('FrontController@performance')}}">
                                            {{ __('Performance')}}</a></li>
                                        <li><a class="nav-link__list" href="{{ action('FrontController@holiday') }}">
                                            {{ __('Annual Holiday List')}}</a></li>
                                    </ul>
                                </div>
                            </li>

                            <li class="nav-item__has-dropdown">
                                <a class="nav-link__list dropdown-toggle" href="#" data-toggle="dropdown"> {{ __('Digital
                                    Campus ')}}</a>
                                <div class="dropdown-menu">
                                    <ul class="list-unstyled">
                                        <li><a class="nav-link__list" href="{{ action('FrontController@multimedia_classroom') }}">{{ __('
                                            Multimedia Class Room ')}}</a></li>
                                        <li><a class="nav-link__list" href="{{ action('FrontController@computer_lab') }}">
                                            {{ __('Computer Lab')}} </a></li>
                                        <li><a class="nav-link__list" href="{{ action('FrontController@science_lab') }}">{{ __('
                                            Science Lab')}} </a></li>
                                    </ul>
                                </div>
                            </li>
                ...
                <li class="nav-item nav-item__has-dropdown">
                    ...
                    <div class="dropdown-menu">
                        <ul class="list-unstyled">
                            <li><a class="nav-link__list" href="{{action('FrontController@managing_committee')}}">{{ __('Managing
                                Committee')}}</a></li>
                ...
                <li class="nav-item nav-item__has-dropdown">
                    ...
                    <div class="dropdown-menu left-auto p-2 p-md-4">
                        <ul class="list-unstyled">
                            <li><a class="nav-link__list px-0" href="{{ action('FrontController@sports_n_culture_program') }}">{{ __('Sports
                                & Cultural Program ')}}</a></li>
                            <li><a class="nav-link__list px-0" href="{{ action('FrontController@center_information') }}">
                                {{ __('Centre Information')}} </a></li>
                            <li><a class="nav-link__list px-0" href="{{ action('FrontController@scholarship_info') }}">
                                {{ __('Scholarship Info')}}</a></li>
                            <li><a class="nav-link__list px-0" href="{{ action('FrontController@bncc') }}"> {{ __('BNCC Info')}} </a></li>
                            <li><a class="nav-link__list px-0" href="{{ action('FrontController@scout') }}"> {{ __('Rover
                                Scouts')}} </a></li>
                ...
                <li class="nav-item nav-item__has-dropdown">
                    ...
                    <div class="dropdown-menu left-auto p-2 p-md-4">
                        <ul class="list-unstyled">
                            ...
                            <li><a class="nav-link__list px-0" href="{{action('FrontController@teacher_attendance')}}">{{ __('Teachers
                                & Staffs')}}</a></li>
                        </ul>
                    </div>
                </li>
