            ...
            @foreach($staffs as $staff)
                ...
                <div class="col">
                    <div class="card" style="width: 210px; height:325px; border: 1px solid #484848;">
                        ...
                        <div class="card-body">
                            <h6  id="idtitle" class="card-title" style="padding: 10px !important; margin:0px !important; color:{{ $card['titlecolor'] }};font-size:{{ $card['title_size']!=null ? $card['title_size'] : 0 }}px">{{ $card['title'] }}</h6>
                        ...
                        {{--<div class="card-body-footer" style="color:{{ $card['titlecolor'] }};font-size:{{ $card['title_size']!=null ? $card['title_size'] : 0 }}px;">--}}
