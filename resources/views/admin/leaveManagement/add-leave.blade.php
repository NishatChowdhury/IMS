                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('student_id',$repository->names(), null, ['placeholder' => 'Select Student Name...','class'=>'form-control']) }}
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-sm-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 col-lg-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('leave_purpose',null,['class'=>'form-control', 'placeholder'=>'Enter Leave Purpose Here:','id'=>'leave_purpose']) }}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
