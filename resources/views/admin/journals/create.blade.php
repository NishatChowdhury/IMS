                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                {!!  Form::select('coa', $coa->pluck('name','id'), array_merge(['class' => 'form-control'])) !!}
                                            </div>
                                        </td>
                                        <td></td>
                                        <td></td>
            ...
            <div class="modal-content" style="left:-150px; width: 1000px !important; padding: 0px 50px;">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        {!!  Form::label('COA', null, ['class' => 'control-label, col-sm-2', 'style'=>'font-weight: 500; text-align: right'])  !!}
                        <div class="col-sm-10">
                            <div class="input-group">
                                {!!  Form::select('coa', $coa->pluck('name','id'), array_merge(['class' => 'form-control'])) !!}
                            </div>
