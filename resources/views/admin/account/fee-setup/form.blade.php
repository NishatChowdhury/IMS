                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="month[]" value="1"
                                       {{  $fee_setup->first() !=null && $fee_setup->first()->month  == 1 ? 'checked' : '' }}>
                    ...
                    @foreach($feeCategories as $category)
                        <tr>
                            ...
                            @if ($fee_setup->count() == 1)
                                @php $isExit1 = \App\FeePivot::query()->where('fee_setup_id',$fee_setup->first()->id)->where('fee_category_id',$category->id)->first() ; @endphp
                                @php
                                    $isExit = \App\FeePivot::query()->where('fee_setup_id',$fee_setup->first()->id)->where('fee_category_id',$category->id)->first() ;
                                @endphp
