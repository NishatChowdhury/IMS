                            ...
                            <div class="col-md-12 ">
                                <div class="left ">
                                    <img src="{{ asset('assets/img/logos') }}/{{ siteConfig('logo') }}"
                                        style="width:.5in ; height:.63in ;    position: relative;top: -7px; text-align: center!important;"
                            ...
                            <div class="col-md-12">
                                <div class="right text-center">
                                    <div class="scl-cd-dec text-wrap text-bold">
                                        <h2
                                            style="padding-top: 3px; position: relative;top: -5px;margin: 2px;text-align: center; font-size:18px; font-weight:500 ;color:#9A001B">
