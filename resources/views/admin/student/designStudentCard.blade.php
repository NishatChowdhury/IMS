                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" placeholder="A. Size ...">
                                                    </div>
                                                </div>
                                                <!-- /input-group -->
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" placeholder="Title Size..">
                                                    </div>
                                                </div>
                                                <!-- /input-group -->
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" placeholder="Body Size..">
                                                    </div>
                                                </div>
                                                <!-- /input-group -->
                                            </div>
                                       ...
                                       <div class="row">
                                           <div class="col-lg-4">
                                               <div class="form-group">
                                                   ...
                                                   <div class="input-group">
                                                       <input id="bPhone" type="number" class="form-control">
                                                       <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                          <input type="checkbox">
                                                        </span>
                                           ...
                                           <div class="col-lg-4">
                                               <div class="form-group">
                                                   ...
                                                   <div class="input-group">
                                                       <input id="bEmail" type="email" class="form-control">
                                                       <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                          <input type="checkbox">
                                                        </span>
                                           ...
                                           <div class="col-lg-4">
                                               <div class="form-group">
                                                   ...
                                                   <div class="input-group">
                                                       <input id="bWebsite" type="text" class="form-control">
                                                       <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                          <input type="checkbox">
                                                        </span>
