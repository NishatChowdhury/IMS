            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="margin: 10px;">
                        <!-- form start -->
                        {{ Form::open(['action'=>'Backend\StudentController@images','role'=>'form','method'=>'get']) }}
                        <div class="card-body">
                            <div class="form-row">
                                <div class="col">
                                ...
                                <div class="row" style="page-break-after: always">
                                    @foreach($chunks as $student)
                                        <div class="col-2 mb-2">
                                            <div class="card">
                                                <div class="card-body">
                                                    <img src="{{ asset('storage/uploads/students/') }}/{{ $student->student->image ?? '' }}" width="180px" height="100px" alt="" class="img-thumbnail" height="135">
                                                    <p class="text-sm text-center">{{$student->rank ?? ''}}</p>
                                                    <p class="text-sm text-center">{{$student->student->name ?? ''}}</p>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
