            ...
            <div class="row">
                ...
                <div style=" margin-top: 3px;">Head Mistress</div>
                                    ...
                                    <div class="col-12" style="padding-top: 50px;">
                                        <div class="card" style="    height: 2.5in; width: 3.9in;   margin-left: 50px; background-color: #191970;   color: white; ">
                                            <div class="card-body text-center" style="border: 1px solid white;   margin: 5px 5px -25px 5px;">
                                                
                                        
                                            <div class="row text-left  " style="text-align: left!important; margin-left: -0.6rem;  margin-right: -0.6rem;  border-bottom: 1px solid white;">
                                                    <div class="col-md-3 ">
                    ...
                    <div> <img src="klr.png" alt="" style="height: 30px;  width: 50px;  border-radius: 50%;   "></div>
                 <div style=" margin-top: 3px;">Head Mistress</div>
