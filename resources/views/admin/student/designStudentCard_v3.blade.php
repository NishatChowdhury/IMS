                                ...
                                <div class="col-12">
                                    <div class="card"
                                        ...
                                        <div
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 ">
                                                        <div class="nat">
                                                            ...
                                                            <h3style="    font-size: 9px;
                                                                font-weight: bold;"> {{ siteConfig('address') }}</h3>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="wrapperr">
                                                <div style="text-align: left; margin-top: 3px; margin-left:5px">{{ __('Cell :
                                                    01837215075') }}</div>
                                    ...
                                    <div class="card"
                                        ...
                                        <div class="card-body text-center"
                                            ...
                                            <div class="row text-left  "
                                                ...
                                                <div class="col-md-9">
                                                    <h3style="padding-top:5px">{{ __('INSTRUCTION') }}</h3>
                                                </div>
                                            </div>
                                            <div class="crd-add-dec text-bold "
                                                ...
                                                <p
                                                    style=" text-align: left;font-size: 15px;    margin-top: 0;  margin-bottom: 0;padding-left:5px">
                                                        {{ __('
                                                    2. This Card is valid upto ') }} <span class="valid-date">{{ __('31-Dec-2020') }}</span> </p>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input cname" checked type="checkbox" id="class"
                                                    name="class">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input gname" checked type="checkbox" id="group"
                                                    name="group">
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input bname" checked type="checkbox" id="blood"
                                                    name="blood">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input rname" checked type="checkbox" id="roll"
                                                    name="roll">
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input dobname" type="checkbox" id="dob"
                                                    name="dob">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input aname" type="checkbox" id="admissiondate"
                                                    name="admissiondate">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <input id="idSignature" name="signature" type="text" class="form-control"
                                                placeholder="signature">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input id="vtd" name="validity" class="form-control datePicker"
                                ...
                                <div class="card-body p-3">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1">{{ __('BG Color') }}</label>
                                                <div class="input-group">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1">{{ __('BG Font Color') }}</label>
                                                <div class="input-group">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1">{{ __('Title Color') }}</label>
                                                <div class="input-group">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input name="name_size" type="text" class="form-control name-size"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input name="address_size" type="text" class="form-control add-size"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input name="title_size" type="text" class="form-control title-size"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input name="body_size" type="text" class="form-control body-size"
                                ...
                                <div class="card-body p-3">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1">{{ __('Phone') }}</label>
                                                <div class="input-group">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1">{{ __('Email') }}</label>
                                                <div class="input-group">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1">{{ __('Website') }}</label>
                                                <div class="input-group">
        ...
        @stop
            ...
            @stop
                ...
                <link
                    ...
                    rel="stylesheet">
                <script
                    src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-colorpicker/2.3.3/js/bootstrap-colorpicker.min.js">
                </script>{{--
