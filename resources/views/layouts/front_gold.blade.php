...
<head>
  ...
  <!-- favicon
		============================================ -->
  <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/front_gold/img/favicon1.ico') }}" />
...
<body>
  ...
  <header>
    ...
    <!-- ------------------ -->
    <div class="col-md-12 text-blue text-center">
       @yield('title_bar')
        ...
        <div class="logo-menu-bg">
          <div class="row">
            <div class="col-lg-3 col-md-12">
              <div class="logo">
                <a href="#"><img src="{{asset('assets/front_gold/img/logo/webpoint_logo.png')}}" alt="logo" /></a>
              </div>
            </div>
