        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card m-3">
                        <!-- form start -->
                        {{ Form::open(['route'=>'admission.browseMeritList','role'=>'form','method'=>'get']) }}
                        <div class="card-body">
                            <div class="form-row">
                                <div class="col">
                        ...
                        <table id="example1" class="table table-bordered table-striped table-sm">
                            ...
                            @foreach($students as $student)
                                <tr>
                                    ...
                                    <td>
                                        @if($stdnt)
                                        {{ Form::open(['route'=>['admission.unapprove',$student->ssc_roll],'method'=>'post','onsubmit'=>'return confirmUnApprove()']) }}
...
@section('script')
    ...
    <script>
        function studentView(roll){
            ...
            $("#loader").show()
            $.ajax({
                url: "{{ route('student.applied-student.view') }}",
