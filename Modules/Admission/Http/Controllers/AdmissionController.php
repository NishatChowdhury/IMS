...
class AdmissionController extends Controller
{
    ...
    public function browseMeritList(Request $request)
    {
        ...
        return view('admission::admission.browse',compact('students','repository','applied','approved'));
    }
    ...
    public function uploadMeritList()
    {
        ...
        return view('admission::admission.upload',compact('onlineApplyStep'));
    }
    ...
    public function slipView(Request $request)
    {
        ...
        return view('admission::admission._slip',compact('student'));
    }
