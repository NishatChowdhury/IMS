                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                @foreach($menus as $menu)
                                    <tr>
                                        ...
                                        <td>
                                            {{ Form::open(['route'=>['menu.destroy',$menu->id],'method'=>'delete','onsubmit'=>'return confirmDelete()']) }}
                                    ...
                                    @foreach($menu->children as $child)
                                        <tr>
                                            ...
                                            <td>
                                                {{ Form::open(['route'=>['menu.destroy',$child->id],'method'=>'delete','onsubmit'=>'return confirmDelete()']) }}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ __('Create Menu') }}</h5>
