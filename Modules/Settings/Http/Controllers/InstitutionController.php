...
//        return $request->all();
        ...
        $studentAcademic = StudentAcademic::query()->where('academic_class_id', $request->academic_class_id)->get();
//        dd($studentAcademic);
        $academic = AcademicClass::query()->find($request->academic_class_id);
