...
class RolePermissionController extends Controller
{
    function roleIndex(){
        $roles = Role::all();
        return view('settings::userManagement.role.index', compact('roles'));
    }
    function roleCreate(){
        $modules = Module::all();
...
//            ;
        ...
        return view('settings::userManagement.role.create', compact('modules','permissionsCount'));
    }
...
//                                        ->orderBy('C')
                                        ...
                                        ->get()
                                        ->groupBy('group_name');
        return view('settings::userManagement.role.edit', compact('role','modules','permissionsCount'));
    }
    ...
    function moduleCreate(){
        return view('settings::userManagement.module.create');
    }
