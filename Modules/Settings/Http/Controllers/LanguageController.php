...
class LanguageController extends Controller
{
    public function index(){
        ...
        return view('settings::language.index',compact('languages','language','active'));
    }
    public function edit($id){
        ...
        $language = Language::query()->where('is_active',1)->pluck('name','id');
        $active = Language::query()->where('default',1)->first();
        return view('settings::language.index',compact('languages','language','active','editData'));
    }
...
//        $lang = Language::findOrFail($req->id);
    ...
    public function translation($id)
    {
        ...
        return view('settings::language.translation',compact('language','lines'));
    }
