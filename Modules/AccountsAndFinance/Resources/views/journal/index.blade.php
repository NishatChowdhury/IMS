        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            {{ Form::open(['route'=>'journals.index','method'=>'get','class'=>'form-inline']) }}
...
{{--                            <h3 class="card-title"><span style="padding-right: 10px;margin-left: 10px;"><i class="fas fa-book" style="border-radius: 50%; padding: 15px; background: #3d807a; color: #ffffff;"></i></span>Total Found : {{ $journals->count() }}</h3>--}}
                            ...
                            <div class="ml-auto media">
                                <a href="{{ route('journals.create') }}" class="btn btn-success align-self-center"><i class="fas fa-plus-circle"></i> Create Journal</a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                @foreach($journals as $journal)
                                    <tr>
                                        ...
                                        <td>
                                            {{ Form::open(['route'=>['journals.destroy',$journal->id],'method'=>'delete','onsubmit'=>'return confirmDelete()']) }}
                                            <a href="{{ route('journals.show',$journal->id) }}" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></a>
