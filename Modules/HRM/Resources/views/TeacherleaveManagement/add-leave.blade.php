...
@section('title','Add Teacher Leave')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ __('Add New Leave') }}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <!-- /.card-header -->
                        <!-- form start -->
                        {!!  Form::open(['route'=>'TeacherLeaveManagement.store', 'method'=>'post', 'enctype'=>'multipart/form-data']) !!}

                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 col-lg-6 col-sm-12">
                                    <div class="form-group">
                                        {{ Form::label('teacher_id','Select Teacher',['class'=>'control-label']) }}
