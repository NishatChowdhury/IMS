            ...
            <div class="modal-content">
                <form action="" method="">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label"
                                style="font-weight: 500; text-align: right">Percentage</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                        ...
                        <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label"
                                style="font-weight: 500; text-align: right">Amount</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                        ...
                        <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label"
                                style="font-weight: 500; text-align: right">Frequency*</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success  btn-sm"> <i class="fas fa-plus-circle"></i>
                            Add</button>
                    </div>
                </form>
            </div>
