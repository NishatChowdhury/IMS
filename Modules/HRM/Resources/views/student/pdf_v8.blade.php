...
<htm llang="en">
        ...
        <div class="row" style="{{ ($key + 1) % 4 == 0 ? 'page-break-after: always' : '' }}">
            @foreach ($chunk as $student)
                <div class="col-3 col-2-5">
                    <div class="card" style="width: 2.5in;height: 3.9in;margin-left: 50px;border-radius: 20px;  ">
                        <div class="font "
                            style="padding-bottom: 0px; width: 2.49in; height: 1.86in; background-color:{{ $card['bgcolor'] }}">
                                ...
                                <div class="row ">
                                    <div class="col-md-3 ">
                                        <img src="{{ asset('assets/img/logos') }}/{{ siteConfig('logo') }}"
                                            alt=""
                                            style="height: 65px;width: 68px;border-radius: 3px;position: absolute;top: 3px;left: 18px;">
                                        ...
                                        <div class="right text-center">
                                            <div class="scl-cd-dec text-wrap text-bold ">
                                                <h2 class="scl-cd-name"
                                                    style="color:{{ $card['bgfont'] }}; position: relative;  top: 10px;  margin: 1px; text-align: center;   font-size: {{ $card['name_size'] != null ? $card['name_size'] : 0 }}px;  font-weight: bold;  font-family: sans-serif;">
                                                    {{ siteConfig('name') }}
                                                </h2>
                                            </div>
                                        </div>
    ...
    <div class=" col-12" style="padding-top: 50px;">
        <div class="card back" style="width: 2.5in; height: 3.9in; margin-left: 33px; border-radius:20px">
            <div class="card-body text-center">
                <div class="roundline"></div>
                <img src="{{ asset('assets/img/logos') }}/{{ siteConfig('logo') }}" width="60"
                    style="  height: 72px;  width: 75px;  text-align: center;  margin: 10px;   border-radius: 6px;">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-back-dec text-bold"
                            ...
                            <h2 style="    text-align: center;   position: relative;  top: 23px;   font-size: 20px;  font-weight: bold;">
                        ...
                        <table class="table" style="font-size: 12px;">
                            <tbody>
                                <tr>
                                    <td> {{ __('Phone') }} </td>
                                    <td>:</td>
                                    <td id="bphone">{{ siteConfig('phone') }} <br>
                                </tr>
                            </tbody>
                        </table>

                        <p class="bottom1"
                            style="background-color:{{ $card['bgcolor'] }}; text-align: center;position: absolute;left: -53px;top: 78px;">
                        </p>
                    </div>
                </div>
            </div>
