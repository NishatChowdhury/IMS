                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card"
                                            style="width: 2.5in;height: 3.9in;margin-left: 50px;border-radius: 10px;  ">
                                            <div class="font ">
                                                <div class="bg">
                                                        ...
                                                        <div class="col-md-9 ">
                                                            <div class="right text-center">
                                                                <div class="scl-cd-dec text-wrap text-bold ">
                                                                    <h2 class="scl-cd-name" style="position: relative;  top: 10px;  margin: 1px; text-align: center;  font-size: 17px;  color: #080808;  font-weight: bold;  font-family: sans-serif;">
                                                                        {{ siteConfig('name') }}
                                                                    </h2>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <table class="table" style="font-size: 12px;">
                                                                    <tbody>
                                                                        <tr class="tname" style="display: block;">
                                                                            ...
                                                                            <td>:</td>
                                                                            <td><strong> {{ __('Student Name') }} </strong>
                                                                            </td>
                                                                        </tr>
                                                                        <tr class="tfname" style="display: block;">
                                                                            ...
                                                                            <td>:</td>
                                                                            <td><strong> {{ __('Father Name') }} </strong>
                                                                            </td>
                                                                        </tr>
                                                                        <tr class="tmname" style="display: block;">
                                                                            ...
                                                                            <td>:</td>
                                                                            <td><strong> {{ __('Mother Name') }} </strong>
                                                                            </td>
                                                                        </tr>
                                    ...
                                    <div class="col-12" style="padding-top: 50px;">
                                        <div class="card back"
                                            style="width: 2.5in; height: 3.9in; margin-left: 50px; border-radius: 10px;   border: 1px solid black;">
                                            <div class="card-body text-center">

                                                <img src="{{ asset('assets/img/logos') }}/{{ siteConfig('logo') }}"
                                                    width="60"
                                                    style="  height: 70px;  width: 70px;  text-align: center;  margin: 10px;   border-radius: 6px;">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div
                                                        class="crd-add-dec text-bold "style="    text-align: center;   position: relative; left: 58px;top: -6px;">
                                                        <table class="table" style="font-size: 12px;">
                                                            <tbody>
                                                                <tr>
                                                                    <td> {{ __('Phone') }} </td>
                                                        ...
                                                        <p class="bottom1"
                                                            style="  text-align: center;position: absolute;left: -53px;top: 78px;">
                            ...
                            <div class="col-md-8">
                                {{ Form::open(['route' => 'student.pdf_V9', 'method' => 'post']) }}
