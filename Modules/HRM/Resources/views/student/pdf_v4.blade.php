        ...
        @foreach ($chunk as $student)
            <div class="col-3 col-2-5">
                <div class="card" style="width: 2.5in; height: 3.9in; margin-left: 50px;  ">
                    <div class="  "
                        style="   background-color:{{ $card['bgcolor'] }};    height: 1.9in;">
                        <div class="row">
                            <div class="col-md-12 ">
                                <div class="left ">
                                    <img src="{{ asset('assets/img/logos') }}/{{ siteConfig('logo') }}" width="50"
                                        style="text-align: center; margin: 5px;   border-radius: 6px; position: relative; top: 5px;"
                                ...
                                <div class="right text-center">
                                    <div class="scl-cd-dec text-wrap text-bold ">
                                        <h2 class="scl-cd-name"
                                            style="position: relative;top: 10px; margin: 1px;text-align: center;  font-size: {{ $card['name_size'] != null ? $card['name_size'] : 0 }}px; color: #fff; font-weight: bold;     font-family: sans-serif;">
                                            {{ siteConfig('name') }}
                                        </h2>
                                    </div>
                                </div>
                    ...
                    <div class="card-body text-center">
                        <div
                            style=" text-align: center; margin-top: 12px; font-size: 18px; font-weight: bold;  color: white;  background-color:{{ $card['bgcolor'] }};   height: 32px;  width: 2.487in; margin-left: -10px; padding: 2px;">
...
<div class="col-12" style="padding-top: 50px;">
    <div class="card" style="width: 2.5in; height: 3.9in; margin-left: 33px;">
        <div class="card-body text-center">
            <img src="{{ asset('assets/img/logos') }}/{{ siteConfig('logo') }}" width="70"
