        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <!-- /.card-header -->
                        <!-- form start -->
                        {!!  Form::open(['route'=>'leavePurpose.store', 'method'=>'post', 'enctype'=>'multipart/form-data']) !!}
                                ...
                                @foreach($leave_purposes as $purpose)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ route('leavePurpose.edit',$purpose->id) }}" role="button" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
