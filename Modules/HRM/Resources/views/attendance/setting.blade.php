                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-primary"
                                                    href="{{ url('admin/attendance/shift/edit') }}/{{ $shift->id }}">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="" class="col-sm-3 col-form-label"
                            style="font-weight: 500; text-align: right">{{ __('Start
                                                                                                                                                                        Time*') }}</label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" name="start" class="form-control" aria-describedby=""
                    ...
                    <div class="form-group row">
                        <label for="" class="col-sm-3 col-form-label"
                            style="font-weight: 500; text-align: right">{{ __('End
                                                                                                                                                                        Time*') }}</label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" name="end" class="form-control" aria-describedby=""
                                    placeholder="hh:mm:ss">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupPrepend2"> <i
                                            class="fa fa-clock nav-icon"></i></span>
                    ...
                    <div class="form-group row">
                        <label for="" class="col-sm-3 col-form-label"
                            style="font-weight: 500; text-align: right">{{ __('Grace
                                                                                                                                                                        Time*') }}</label>
                        <div class="col-sm-9">
                            <div class="">
                    ...
                    <div class="form-group row">
                        <label for="" class="col-sm-3 col-form-label"
                            style="font-weight: 500; text-align: right">{{ __('Late
                                                                                                                                                                        Present Fee*') }}</label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                ...
                                <input type="text" name="late_fee" class="form-control" id=""
                                    placeholder="0" aria-describedby="">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="" class="col-sm-3 col-form-label"
                            style="font-weight: 500; text-align: right">{{ __('Absent
                                                                                                                                                                        Fee*') }}</label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                ...
                                <input type="text" name="absent_fee" class="form-control" id=""
                                    placeholder="0" aria-describedby="">
                            </div>
                        </div>
                    </div>
