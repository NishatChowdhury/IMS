        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-9">
                            {{ Form::open(['route'=>'attendance.report','method'=>'get','id' => 'changeAction']) }}
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="col">
                        ...
                        <div class="col-md-3">
                            <div>
                                <ul style="list-style: none">
                                    ...
                                    <li> <i class="fas fa-circle" style="color: #ffa500"></i> <span> {{ __('E - Early Leave')}} </span></li>
    ...
    <script>
        ...
        $('#statusChange').change(function (){
            ...
            if(statusValue == 1){   // Student for 1
                $('#forStudent').show();
               let action = "{{ route('attendance.report') }}";
                $('#changeAction').attr("action", action);
            }
        })

         let action = "{{ route('Battendance.report') }}";
        $('#changeAction').attr("action", action);
