...
<head>
    ...
    <title>Module VirtualClassroom</title>
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
        @include('virtualclassroom::includes.header')
    </nav>
    <!-- /.navbar -->

    <!-- Main Sidebar Container -->
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
    @include('virtualclassroom::includes.left-sidebar')
    <!-- /.sidebar -->
    </aside>
...
<!-- Control Sidebar -->
    <aside class="control-sidebar control-sidebar-dark">
        ...
        @include('virtualclassroom::includes.right-aside')
    </aside>
    <!-- /.control-sidebar -->
    <div class="notprint">
        <footer class="main-footer no_print">
            @include('virtualclassroom::includes.footer')
        </footer></div>
