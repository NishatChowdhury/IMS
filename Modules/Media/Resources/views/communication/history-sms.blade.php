                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="dec-block" style="float: right; margin-top: 20px; margin-right: 100px;">
                                        <a href="#" class="btn btn-success btn-sm" style="padding: 5px 15px"><i
                                ...
                                <tbody>
                                    @foreach ($histories as $history)
                                        <tr>
                                            ...
                                            <td><span
                                                    title="{{ $history->numbers }}">{{ $d = $history->destination_count }}</span>
                                            </td>
                                            <td><span
                                                    title="{{ $history->message }}">{{ $s = $history->sms_count }}</span>
                                            </td>
                                            <td>{{ $d * $s }}</td>
                                        </tr>
                                    @endforeach
