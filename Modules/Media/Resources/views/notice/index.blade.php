                                ...
                                <tbody>
                                    @foreach ($notices as $notice)
                                        <tr>
                                            ...
                                            <td>
                                                {{ Form::model($notice, ['route' => ['notice.destroy', $notice->id], 'method' => 'delete', 'onsubmit' => 'return confirmDelete()']) }}
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="" class="col-sm-2 col-form-label"
                            style="font-weight: 500; text-align: right">Type*</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="" class="col-sm-2 col-form-label"
                            style="font-weight: 500; text-align: right">Category*</label>
                        <div class="col-sm-10">
                            <div class="input-group">
                    ...
                    <div class="form-group row">
                        <label for="" class="col-sm-2 col-form-label"
                            style="font-weight: 500; text-align: right">Notice file*</label>
                        <div class="col-sm-10">
