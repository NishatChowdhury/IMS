            ...
            <div class="modal-content" style="width: 700px">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="" class="col-form-label"
                                style="font-weight: 500; text-align: right">{{ __('Album') }}</label>
                            <div class="input-group">
                        ...
                        <div class="form-group col-md-6">
                            <label for="" class="col-form-label"
                                style="font-weight: 500; text-align: right">{{ __('Tags') }}</label>
                            <div class="input-group">
                        ...
                        <div class="form-group col-md-6">
                            <label for="" class="col-form-label"
                                style="font-weight: 500; text-align: right">{{ __('Short
                                                                                                                                                                                                                                                                                                                                                                                                                            Description') }}</label>
                            <div class="input-group">
                                <textarea type="text" name="description" class="form-control" rows="5" id=""
                                    placeholder="Enter Some Description About Images . . ."> </textarea>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="" class="col-form-label"
                            ...
                            <div class="form-group files color">
                                <input type="file" name="image[]" class="form-control" multiple=""
                                    style="padding: 48px 0px 85px 24%!important">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer"><button type="submit" class="btn btn-success  btn-sm btn-block"> <i
