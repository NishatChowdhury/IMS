                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header" style="border-bottom: none !important;">
                            <div class="row">
                                <a href="{{ route('event.create') }}" class="btn btn-info btn-sm"> <i class="fas fa-plus-circle"></i> Add Event</a>
                            </div>
                        </div>
                                ...
                                @foreach($events as $event)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('event.edit',$event->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
