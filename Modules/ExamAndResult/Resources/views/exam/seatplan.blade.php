            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="margin: 10px;">
                        <!-- form start -->
                        {{ Form::open(['route'=>'exam-seat-plan.storeSeatPlan','role'=>'form','method'=>'post']) }}
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-sm">
                                ...
                                @foreach($data as $seat)
                                    <tr class="text-center">
                                        ...
                                        <td>{{ $seat->count }}</td>
                                        <td>
                                            {!! Form::open(['route'=>['exam-seat-plan.destroy',$seat->id],'method'=>'delete','onsubmit'=>'return confirmDelete()']) !!}
