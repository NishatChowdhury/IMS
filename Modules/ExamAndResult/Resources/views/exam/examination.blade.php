                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('exam-seat-plan.seatPlan',$exam->id) }}" class="btn btn-dark btn-sm" title="Exam Set Plan"><i class="fa fa-th"></i></a>
                                        ...
                                        <a href="{{ route('exam.schedule.index',$exam->id) }}" class="btn btn-info btn-sm" title="Exam Schedule"><i class="far fa-calendar-alt"></i></a>
                                        <a href="{{ route('exam.tabulation',$exam->id) }}" class="btn btn-dark btn-sm" title="Tabulation Sheet"><i class="fas fa-list-ol"></i></a>
{{--                                        <a type="button" href="{{ action('Backend\ExamController@delete_exam',$exam->id) }}" class="btn btn-danger btn-sm" style="margin-left: 5px;" title="Delete"><i class="fas fa-trash "></i></a>--}}
                                        ...
                                        <a href="{{ route('exam.generateResult',$exam->id) }}" role="button" class="btn btn-success btn-sm"><i class="fas fa-sync-alt"></i></a>
                                        {{ Form::close() }}
                                    </td>
                                </tr>
                                @endforeach
