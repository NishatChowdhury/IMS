...
<head>
    ...
    <title>Module ExamAndResult</title>
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
        @include('examandresult::includes.header')
    </nav>
    <!-- /.navbar -->

    <!-- Main Sidebar Container -->
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
    @include('examandresult::includes.left-sidebar')
    <!-- /.sidebar -->
    </aside>
...
<!-- Control Sidebar -->
    <aside class="control-sidebar control-sidebar-dark">
        ...
        @include('examandresult::includes.right-aside')
    </aside>
    <!-- /.control-sidebar -->
    <div class="notprint">
        <footer class="main-footer no_print">
            @include('examandresult::includes.footer')
        </footer></div>
