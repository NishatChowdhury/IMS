                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div style="float: left;">
                                        <a href="{{ route('exam.schedule.create',$examId) }}" role="button" class="btn btn-info btn-sm"> <i class="fas fa-plus-circle"></i>
                        ...
                        <div class="card-body">
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                @foreach($schedule as $key => $sc)
                                        ...
                                        <td>
                                            <a href="{{ route('exam-marks.download',$sc->id) }}" class="btn btn-success btn-sm" title="{{ __('Download Result') }}"><i class="fas fa-file-download"></i></a>
                                            <a href="{{ route('exam-marks.upload',$sc->id) }}" class="btn btn-success btn-sm" role="button" style="color:white" title="{{ __('Upload Result') }}"><i class="fas fa-file-upload"></i></a>
                                            <a href="{{ route('exam-marks.index',$sc->id) }}" class="btn btn-info btn-sm" title="{{ __('Input Marks') }}"><i class="fas fa-file-invoice"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="left:-150px; width: 1000px !important; padding: 0px 50px;">
                ...
                <div class="modal-body">
                    {!! Form::open(['route'=>['exam.schedule.index',5], 'method'=>'post']) !!}
