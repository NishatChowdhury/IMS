...
<head>
    ...
    <title>Module ExamAndResult V2</title>
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
        @include('examandresultv2::includes.header')
    </nav>
    <!-- /.navbar -->

    <!-- Main Sidebar Container -->
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
    @include('examandresultv2::includes.left-sidebar')
    <!-- /.sidebar -->
    </aside>
...
<!-- Control Sidebar -->
    <aside class="control-sidebar control-sidebar-dark">
        ...
        @include('examandresultv2::includes.right-aside')
    </aside>
    <!-- /.control-sidebar -->
    <div class="notprint">
        <footer class="main-footer no_print">
            @include('examandresultv2::includes.footer')
        </footer></div>
