            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ __('Allocate Seat')}}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div>
                                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#allocateseat" data-whatever="@mdo"  style="margin-top: 10px;"> <i class="fas fa-plus-circle"></i>
                                            {{ __('Add')}}</button>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="dec-block">
                                        ...
                                        <div class="dec-block-dec" style="float:left;">
                                            <h5 style="margin-bottom: 0px;">{{ __('Total Exam Candidate')}}</h5>
                                            <p>150</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="dec-block">
                                        ...
                                        <div class="dec-block-dec" style="float:left;">
                                            <h5 style="margin-bottom: 0px;">{{ __('Seat Selected')}}</h5>
                                            <p>0</p>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="left:-150px; width: 1000px !important; padding: 0px 50px;">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ __('Allocate Seat')}}</h5>
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label" style="font-weight: 500; text-align: right">{{ __('Class')}}</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <select class="form-control" id="">
                                        <option>{{ __('Select Section')}}</option>
                                        <option>{{ __('Select Section')}}</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label" style="font-weight: 500; text-align: right">{{ __('Room
                                No')}}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                        ...
                        <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label" style="font-weight: 500; text-align: right">{{ __('Seat
                                From')}}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" id=""  aria-describedby="">
                        ...
                        <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label" style="font-weight: 500; text-align: right">{{ __('Total
                                Seat')}}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" id=""  aria-describedby="">
