...
<head>
    ...
    <title>Module ExtraCurriculum</title>
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
        @include('extracurriculum::includes.header')
    </nav>
    <!-- /.navbar -->

    <!-- Main Sidebar Container -->
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
    @include('extracurriculum::includes.left-sidebar')
    <!-- /.sidebar -->
    </aside>
...
<!-- Control Sidebar -->
    <aside class="control-sidebar control-sidebar-dark">
        ...
        @include('extracurriculum::includes.right-aside')
    </aside>
    <!-- /.control-sidebar -->
    <div class="notprint">
        <footer class="main-footer no_print">
            @include('extracurriculum::includes.footer')
        </footer></div>
