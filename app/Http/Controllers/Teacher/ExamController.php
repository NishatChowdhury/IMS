...
class ExamController extends Controller
{
    ...
    public function examList()
    {
        ...
        return view ('teacher.exam.examination', compact('exams','repository'));
    }

    public function examSchedule(Request $request,$examId)
    {

        $asT = AssignSubject::query()
                                ->where('teacher_id', auth()->guard('teacher')->user()->staff_id)
                                ->get();
         $getTeacherAssign = $asT->groupBy('academic_class_id');
//        return $newA;
        ...
        return view('teacher.exam.schedule', compact('getTeacherAssign','session_id', 'examId','schedules','sessions','exams','classes', 'class_id', 'exam_type', 'subjects', 'teachers'));

    }

    // input mark

     public function markIndex($schedule)
    {
...
//        return $students;
        ...
        return view('teacher.exam.exam-mark',compact('students','examSchedule','table'));
    }
...
//            dd($data);
    ...
    public function markUpload($schedule)
    {
            $schedule = ExamSchedule::query()->findOrFail($schedule);
            return view('teacher.exam.upload',compact('schedule'));
    }
...
//                    return $data;
    ...
    public function markDownload($schedule)
    {
