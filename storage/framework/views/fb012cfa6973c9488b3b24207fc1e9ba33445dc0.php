        ...
        <div class="row text-center text-white">
            ...
            <div class="col-lg-3 col-md-6 mt-5 wow zoomIn" data-wow-delay=".1">
                <h2 class="h1 text-primary">
                    <?php echo e(\App\Models\Backend\Student::all()->count()); ?>
            ...
            <div class="col-lg-3 col-md-6 mt-5 wow zoomIn" data-wow-delay=".2">
                <h2 class="h1 text-primary">
                    <?php echo e(\App\Models\Backend\AcademicClass::all()->count()); ?>
            ...
            <div class="col-lg-3 col-md-6 mt-5 wow zoomIn" data-wow-delay=".4">
                <h2 class="h1 text-primary">
                    <?php echo e(\App\Models\Backend\Staff::all()->count()); ?>
...
<?php /**PATH /home/maynuddin/PhpstormProjects/wpschool/resources/views/front/progress-bar.blade.php ENDPATH**/ ?>