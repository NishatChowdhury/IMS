<?php $__env->startSection('title','Institution Mgnt | Classes'); ?>
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <?php $__currentLoopData = $sections ?? ''; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a type="button" class="btn btn-info btn-sm edit_sec" value='<?php echo e($section->id); ?>'
                                           style="margin-left: 5px;"> <i class="fas fa-edit"></i>Edit
                                        </a>

                                        <a type="button" href="<?php echo e(action('Backend\InstitutionController@delete_section',$section->id)); ?>"
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <?php $__currentLoopData = $groups ?? ''; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a type="button" class="btn btn-info btn-sm edit_group" value='<?php echo e($group->id); ?>'
                                           style="margin-left: 5px;"> <i class="fas fa-edit"></i>Edit
                                        </a>
                                        <a type="button" href="<?php echo e(action('Backend\InstitutionController@delete_grp',$group->id)); ?>"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="left:-30%; width: 700px !important; padding: 0px 50px;">
                ...
                <div class="modal-body">
                    <?php echo Form::open(['action'=>'Backend\InstitutionController@create_section', 'method'=>'post']); ?>
    ...
    <div class="modal fade" id="GroupModal" tabindex="-1" role="dialog" aria-labelledby="groupModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="left:40%; width: 700px !important; padding: 0px 50px;">
                ...
                <div class="modal-body">
                    <?php echo Form::open(['url'=>'admin/institution/create-group', 'method'=>'post']); ?>
    ...
    <div class="modal fade" id="edit_sec" tabindex="-1" role="dialog" aria-labelledby="groupModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="left:-30%; width: 700px !important; padding: 0px 50px;">
                ...
                <div class="modal-body">
                    <?php echo Form::open(['url'=>'admin/institution/update-section', 'method'=>'post']); ?>

                    <?php echo Form::hidden('id', null, ['id'=>'sec_id']); ?>
    ...
    <div class="modal fade" id="edit_group" tabindex="-1" role="dialog" aria-labelledby="groupModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="left:40%; width: 700px !important; padding: 0px 50px;">
                ...
                <div class="modal-body">
                    <?php echo Form::open(['url'=>'admin/institution/update-group', 'method'=>'post']); ?>

                    <?php echo Form::hidden('group_id', null, ['id'=>'group_id']); ?>
...
<?php $__env->startSection('script'); ?>
    <script>
        $(document).on('click', '.edit_sec', function () {
            ...
            $.ajax({
                method:"post",
                url:"<?php echo e(url('admin/institution/edit-section')); ?>",
        ...
        $(document).on('click', '.edit_group', function () {
            ...
            $.ajax({
                method:"post",
                url:"<?php echo e(url('admin/institution/edit-group')); ?>",
                data:{id:id,"_token":"<?php echo e(csrf_token()); ?>"},
                dataType:"json",
                success:function(response){
                    console.log(response);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.fixed', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maynuddin/PhpstormProjects/wpschool/resources/views/admin/institution/section-group.blade.php ENDPATH**/ ?>