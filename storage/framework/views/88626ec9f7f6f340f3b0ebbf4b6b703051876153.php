<?php $__env->startSection('title','WPIMS | Dashboard'); ?>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?php echo e($students); ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?php echo e($teachers); ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?php echo e($classes); ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-md-4">
                    ...
                    <div class="info-box mb-3 bg-warning">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?php echo e($studentMale); ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                    <div class="info-box mb-3 bg-success">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?php echo e($studentFemale); ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                    <div class="info-box mb-3 bg-danger">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?php echo e($teacherMale); ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                    <div class="info-box mb-3 bg-info">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?php echo e($teacherFemale); ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                                ...
                                <?php if($calenders->count() > 0): ?>
                                    <table class="table table-condensed">
                                        ...
                                        <?php $__currentLoopData = $calenders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $calender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr >
                                                <td>
                                                    <?php echo e($calender->name); ?>

                                                </td>
                                                <td>
                                                    <?php echo e(\Carbon\Carbon::parse($calender->start)->format('d M')); ?>

                                                </td>
                                                <td>
                                                    <?php echo e(\Carbon\Carbon::parse($calender->end)->format('d M')); ?>
                                                ...
                                                <td>
                                                    ...
                                                    <small class="badge badge-primary">
                                                        <i class="far fa-clock"></i> <?php echo e($days->days); ?>
                                ...
                                <?php if($notices->count() > 0): ?>
                                    <?php $__currentLoopData = $notices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            ...
                                            <span class="text"><?php echo e($notice->title); ?></span>
                                            <!-- Emphasis label -->
                                            <small class="badge badge-success"><i class="far fa-clock"></i> <?php echo e(\Carbon\Carbon::parse($notice->start)->format('d F Y')); ?></small>
                                            <!-- General tools such as edit or delete-->
                                            <div class="tools">
...
<?php echo $__env->make('layouts.fixed', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maynuddin/PhpstormProjects/wpschool/resources/views/admin/dashboard/dashboard.blade.php ENDPATH**/ ?>