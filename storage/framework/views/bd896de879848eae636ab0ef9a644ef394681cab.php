                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <?php $__currentLoopData = $classes ?? ''; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($class->numeric_class); ?></td>
                                        <td> <?php echo e($class->student_academic_count); ?> </td>
                                        <td><?php echo e($class->subjects->count()); ?></td>
                                        <td></td>
                                        <td>

                                            <a type="button" class="btn btn-warning btn-sm edit" value='<?php echo e($class->id); ?>'
                                               style="margin-left: 10px;"> <i class="fas fa-edit"></i>
                                            </a>

                                            <a type="button" href="<?php echo e(action('Backend\InstitutionController@delete_SessionClass', $class->id)); ?>"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="left:-150px; width: 1000px !important; padding: 0px 50px;">
                ...
                <div class="modal-body">
                    ...
                    <?php echo Form::open(['action'=>'Backend\InstitutionController@store_class', 'method'=>'post']); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <?php echo Form::text('name', null, ['class'=>'form-control', 'placeholder'=>'Class Name']); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <?php echo Form::text('numeric_class', null, ['class'=>'form-control', 'placeholder'=>'E.g. 1/2/3']); ?>
    ...
    <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="left:-150px; width: 1000px !important; padding: 0px 50px;">
                ...
                <div class="modal-body">
                    <?php echo Form::open(['action'=>'Backend\InstitutionController@update_SessionClass', 'method'=>'post']); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <?php echo Form::text('name', null, ['class'=>'form-control class_name', 'placeholder'=>'Class Name']); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <?php echo Form::text('numeric_class', null, ['class'=>'form-control numeric_class', 'placeholder'=>'E.g. 1/2/3']); ?>
...
<?php $__env->startSection('script'); ?>
    <script>
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                method:"post",
                url:"<?php echo e(url('admin/institution/edit-SessionClass')); ?>",
...
<?php echo $__env->make('layouts.fixed', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maynuddin/PhpstormProjects/wpschool/resources/views/admin/institution/classes.blade.php ENDPATH**/ ?>