<?php $__env->startSection('title','Institution Mgnt | Subjects'); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="badge badge-danger">
                                                <?php echo e($subject->type == 1 ? 'Compulsory' : ''); ?>

                                                <?php echo e($subject->type == 2 ? 'Optional' : ''); ?>

                                                <?php echo e($subject->type == 3 ? 'Selective' : ''); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <a type="button" class="btn btn-warning btn-sm edit" value='<?php echo e($subject->id); ?>'
                                               style="margin-left: 10px;" title="EDIT"> <i class="fas fa-edit"></i>
                                            </a>

                                            <a type="button" href="<?php echo e(action('Backend\InstitutionController@delete_subject', $subject->id)); ?>"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="left:-150px; width: 1000px !important; padding: 0px 50px;">
                ...
                <div class="modal-body">
                    <?php echo Form::open(['action'=>'Backend\InstitutionController@create_subject', 'method'=>'post']); ?>
    ...
    <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="left:-150px; width: 1000px !important; padding: 0px 50px;">
                ...
                <div class="modal-body">
                    <?php echo Form::open(['action'=>'Backend\InstitutionController@update_subject', 'method'=>'post']); ?>

                    <?php echo Form::hidden('id', null, ['id'=> 'sub_id']); ?>
...
<?php $__env->startSection('script'); ?>
    <script>
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                method:"post",
                url:"<?php echo e(url('admin/institution/edit-subject')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.fixed', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maynuddin/PhpstormProjects/wpschool/resources/views/admin/institution/subjects.blade.php ENDPATH**/ ?>