<?php $__env->startSection('title','Settings | Pages'); ?>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header" style="border-bottom: none !important;">
                            ...
                            <div class="row">
                                <div>
                                    <a class="btn btn-info btn-sm" href="<?php echo e(action('Backend\PageController@create')); ?>" style="margin-top: 10px; margin-left: 10px;"> <i class="fas fa-plus-circle"></i> New</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td style="line-break:anywhere"><?php echo e(substr(strip_tags($page->content),0,99)); ?></td>
                                    <td><?php echo e($page->order); ?></td>
                                    <td>
                                        <?php echo e(Form::model($page,['action'=>['Backend\PageController@destroy',$page->id],'method'=>'delete','onsubmit'=>'confirmDelete()'])); ?>

                                        <a href="<?php echo e(action('Backend\PageController@edit',$page->id)); ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                            ...
                            <div class="row" style="margin-top: 10px">
                                <div class="col-sm-12 col-md-9">
                                    <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">Showing <?php echo e($pages->firstItem()); ?> to <?php echo e($pages->count()); ?> of <?php echo e($pages->total()); ?> entries</div>
                                </div>
...
<?php $__env->startSection('style'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/editor.css')); ?>">
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.fixed', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/maynuddin/PhpstormProjects/wpschool/resources/views/admin/page/index.blade.php ENDPATH**/ ?>